...
public class MathTools
{
    ...
    public static bool Lines2DIntersection(Vector2 p1, Vector2 p2, Vector2 p3, Vector2 p4, ref Vector2 intersection)
    {
    ...
    public static Vector3 EulerAnglesToNegative(Vector3 euler)
    {
        Vector3 e = euler;
        if (e.x > 180f)
            e.x -= 360f;
